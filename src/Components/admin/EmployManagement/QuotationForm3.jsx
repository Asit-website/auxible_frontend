...
const QuotationForm3 = ({ setAlert, pop, setPop }) => {
  const {
    user,
    uploadSingleImage,
  ...
  const addRow = () => {
    setRows([...rows, {area: "", model: "", description: "" , qty:"" , unitPrice:"" , amount:"" },]);
  };
            ...
            <div className="qutaWrap">
              ...
              {preview && (
                    ...
                    <div ref={contonentPDF} className="qutaRightcont">
                      ...
                      <div className="talbeLike">
                        <div class="relative w-full">
                         <p className="aubdisolpara2 text-white">LIGHTING SOLUTION</p>
                            ...
                            <tbody>
                              {rows.map((row, index) => (
                                <tr className="bg-white quotabletr2 " key={index}>
                                  ...
                                  <td className="px-2 py-2 prewid2">{row.area} </td>
                                  <td className="px-2 py-2 prewid4">{row.description}</td>
                                  <td className="px-2 py-2 prewid1">{row.qty}</td>
                                  <td className="px-2 py-2 prewid1">{row.unit}</td>
                                  <td className="px-2 py-2 prewid5">{row.price}</td>
               ...
               <div className="quo1_termandcond">
                ...
                <p className="hard_para">Valid period of the above quotation: 15 days Excluded:Supporting frame, Structure, And any civil & electrical work.</p>
                <p className="hard_para">Included:Installation, Delivery, Module, PowerSupply, & Cable, Receiving & Sending card, Controller, Training,</p>
                <p className="hard_para">Payment term: 100% down payment, before shipment</p>
                <p className="hard_para">Installation-Technical Assitance will be provided by us during installation. All outstationCharge of engineer will be bear by client only</p>
                <p className="hard_para">Warrantly: ONE year warranty (can be extend up to 5 years AMC) voltage Stabilizerto be provided by client in case of voltage fluctation A computer,</p>
